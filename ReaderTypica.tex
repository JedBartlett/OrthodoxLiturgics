...
\date{}
\author{}
%\date{St. Katherine Orthodox Church\\Moscow, Id}

\input{./SundayReaderTypica/liturgy.tex}

\begin{document}
	\maketitle
	\graphicalinnerpage{Saint Katherine Orthodox Church}{./Images/Katherine1}{Moscow, Idaho}

	\section*{The Sunday Reader's Service of Typica}
		...
		\subsection*{The First Antiphon}
			\subsectionnote{This may be replaced for certain feast days.}

			\lilyantiphonone

			\reader \lhmThree

		\subsection*{The Second Antiphon}
		...
		\subsection*{Troparia}
			\subsectionnote{This is modified on Great Feasts.}
		...
		\subsubsection*{Theotokion for Ordinary Sundays}
			\subsectionnote{This is often replaced with a Theotokion specific to the day.}
