...
\newcommand{\MARGINWIDTH}{0.5in}

\setlength{\paperwidth}{\PAPERWIDTH}
\setlength{\paperheight}{\PAPERHEIGHT}

\usepackage{calc}
\usepackage[left=\MARGINWIDTH+5em,right=\MARGINWIDTH,top=\MARGINWIDTH,bottom=\MARGINWIDTH+0.25in,footskip=0.25in]{geometry}
\usepackage{titlesec}
\usepackage{color}
...
% Use a darker royal red, instead of 0xff0000.
...
\newtoggle{Pentecost}
\newtoggle{Ascension}
% Preprocessing will replace this with one of the 4 toggles defined above.
\toggletrue{Pentecost}


% Put paragraph titles in the left margin in red.  The paragraph titles are the
% part callouts ("Priest", "Reader", "People").
\titleformat{\paragraph}[leftmargin]{\scshape}{1em}{}{\color{\myred}}
\titlespacing{\paragraph}{4em}{1.5ex minus .1 ex}{1em}
% Sections are full services.  Start each on a new page.
\newcommand{\sectionbreak}{\clearpage}


\fancyhead{}
\renewcommand{\headrulewidth}{0pt}
% Flank the page numbers with decorations.
\fancyfoot[C]{
...
% This isn't used currently.  It takes a long time to draw the fancy borders.
% Way too long to do it on each page.
...
\begin{tikzpicture}[remember picture, overlay]
	...
	\pgfmathsetlength{\framewidth}{\PAPERWIDTH - 2*\MARGINWIDTH + 0.5in};
	\pgfmathsetlength{\frameheight}{\PAPERHEIGHT - 2*\MARGINWIDTH + 0.5in};
...
% Define an italic, centered note format that is used immediately below
% subsection titles.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Now define the title and inner pages.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand\liturgytitle[1]{
	\newlength{\titlemargin}
	\setlength{\titlemargin}{\MARGINWIDTH+\MARGINWIDTH}
	\newgeometry{left=\MARGINWIDTH+\MARGINWIDTH,right=\MARGINWIDTH+\MARGINWIDTH,top=\MARGINWIDTH+\MARGINWIDTH,bottom=\MARGINWIDTH+\MARGINWIDTH+0.25in,footskip=0.25in}
	%\maketitle
	\thispagestyle{empty}
	\vspace*{\fill}
	\begin{center}
		\Huge{#1\iftoggle{Pascha}{\\(Paschal)}{\iftoggle{Lent}{\\(Lenten)}{\iftoggle{Ascension}{\\(Ascension Sunday)}{}}}}
	\end{center}
	\vspace*{\fill}
	\vspace*{1in}
	\eachpageornament
...
\newcommand\graphicalinnerpage[3]{
	\vspace*{\fill}
	\begin{center}
		\Large{#1}

		\includegraphics[width=\textwidth]{#2}	% By the time Latex will actually be processing this, it will be in an out.* subdirectory.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Now define a whole series of common liturgical snippets.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Using \nolinebreak\\ to break each line prevents lines being skipped when
% a psalm line ends at the right margin, where a natural line break would be
% followed by the forced one.  This prevents any natural line breaks from
% happenning immediately before a forced one.
\newcommand\psalm[1]{
\switch[#1 =]
	\case{16}
...
% We need to ensure a line break before music.
% If I remember correctly, this is to keep the paragraph heading ("People") which
% is in the left margin at the top of the first staff, rather than at the bottom.
% I really wanted it vertically centered with the top staff, aligned with the lyrics
% but couldn't get that.
\newcommand\lilyalleluia{\lilypondfile{./Common/alleluia.ly}}

\newcommand\lilyantiphonone{\lilypondfile{./Common/bless_the_lord_greek.ly}}

\newcommand\lilyantiphontwo{\lilypondfile{./Common/praise_the_lord_greek.ly}}

\newcommand\lilyamen{\lilypondfile{./Common/amen.ly}}

\newcommand\lilybeatitudes{\lilypondfile{./Common/beatitudes.ly}}

\newcommand\lilyblessedbethename{\lilypondfile{./Common/blessed_be_the_name_flat.ly}}

\newcommand\lilydismissal{\lilypondfile{./Common/dismissal_obikhod.ly}}

\newcommand\lilyentrance{\lilypondfile{./Common/entrance.ly}}

\newcommand\lilyglory{\lilypondfile{./Common/glory_to_thee.ly}}

\newcommand\lilykontakkatherine{\lilypondfile{./Common/kontak_katherine_obikhod.ly}}

\newcommand\lilysundaytheotokion{\lilypondfile{./Common/steadfast_protectress.ly}}

\newcommand\lilytrisagiona{\lilypondfile{./Common/trisagion_byzantine_a.ly}}

\newcommand\lilytrisagionb{\lilypondfile{./Common/trisagion_byzantine_b.ly}}

\newcommand\lilytroparkatherine{\lilypondfile{./Common/tropar_katherine_obikhod.ly}}

\newcommand\lilytrulymeet{\lilypondfile{./Common/truly_meet_obikhod.ly}}
