...
\priestline{Glory to Thee, O God \instruction{THRICE}}
...
\emph{``Holy God, Holy Mighty, Holy Immortal: have mercy on us. (3x)''}}
...
\begin{reader}
\item Amen.
\item Lord, have mercy. \instruction{(12x)}
...
\begin{reader}
  ...
  \item Alleluia. Alleluia. Alleluia. Glory to Thee, O God. \instruction{(3x)}
  \item Lord have mercy. \instruction{(3x)}
  \item Glory to the Father and to the Son and to the Holy Spirit.
\end{reader}
...
\instruction{During Lent}
\input{./Common/PrayerOfStEphraim.tex}
