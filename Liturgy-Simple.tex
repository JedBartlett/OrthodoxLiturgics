...
\lilypondfile{./Z-Responses/Obikhod/LordHaveMercy-Plain.ly}
...
\end{deacon}
\instruction{Alternate between these responses until the enf of the litany}
\lilypondfile{./Z-Responses/Kievan/GrantThisOLord-A.ly}

\deaconline{An angel of peace, a faithful guide, a gaurdian of our souls and bodies,
 let us ask of the Lord.}
...
\priestline{Singing the triumphl hymn, shouting, proclaiming and saying:}
...
\priestline{And likewize after supper, he took the cup saying:
  Drink of this, all of tou. This is my Blood of the new covenant,
  which is shed for you and for many, for the forgiveness of sins.}
\lilypondfile{./Z-Responses/Obikhod/Amen2.ly}

\priestline{Thine own of Thine own, we offer unto Thee on behalf of all and for all.}
