...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Kazan/Amen.ly}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Kazan/LordHaveMercy-A.ly}

\deaconline{For the peace from above and the salvation of our souls, let us pray to the Lord.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Kazan/LordHaveMercy-B.ly}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Kazan/LordHaveMercy-C.ly}
...
\end{deacon}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Kazan/LordHaveMercy-Z.ly}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Kazan/ToTheeOLord.ly}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Obikhod/Amen.ly}
\end{maybetwocolumns}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Obikhod/AndToThySpirit.ly}

\deaconline{The reading from the holy gospel according to \instruction{N.}}
\lilypondfile[max-protrusion=-0.4in]{./Liturgy/J-EpistleGospel/GloryToThee_Obikhod-Music.ly}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Greek/PreThrefoldLhm_A.ly}

\deaconline{O Lord Almighty, the God of our fathers, we pray Thee hearken and have mercy.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Greek/PreThrefoldLhm_B.ly}
\end{maybetwocolumns}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/NKedrov/LordHaveMercyCatechumens_A.ly}

\deaconline{Let us, the faithful, pray for the catechumens,
  that the Lord will have mercy on them.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/NKedrov/LordHaveMercyCatechumens_B.ly}

\deaconline{That He will teach them the word of truth.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/NKedrov/LordHaveMercyCatechumens_C.ly}

\deaconline{That He will reveal to them the gospel of righteousness.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/NKedrov/LordHaveMercyCatechumens_D.ly}

\deaconline{That He will unite them to His holy, catholic and apostolic Church.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/NKedrov/LordHaveMercyCatechumens_E.ly}

\deaconline{Save them; have mercy on them; help them; and keep them, O God, by Thy grace.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/NKedrov/LordHaveMercyCatechumens_F.ly}

\deaconline{Bow your heads unto the Lord, ye catechumens.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/NKedrov/ToTheeOLord.ly}
...
\priestline{That with us they may glorify Thine all-honorable and majestic name of the Father
  ...
  now and ever, and unto ages of ages.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/NKedrov/Amen.ly}
\end{maybetwocolumns}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/NKedrov/LordHaveMercy_A.ly}

\deaconline{Help us; save us; have mercy upon us; and keep us, O God, by Thy grace.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/NKedrov/LordHaveMercy_B.ly}
...
\priestline{That gaurded always by Thy might we may ascribe glory unto Thee
  ...
  now and ever, and unto ages of ages.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/NKedrov/Amen_B.ly}
\end{maybetwocolumns}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Obikhod/LordHaveMercy-A.ly}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Kievan/LordHaveMercy-B.ly}

\deaconline{For this Holy house and those who with faith, reverence and fear of God enter therein,
  let us pray to the Lord.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Kievan/LordHaveMercy-A.ly}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Kievan/GrantThisOLord-A.ly}

\deaconline{An angel of peace, a faithful guide, a guardian of our souls and bodies,
 let us ask of the Lord.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Kievan/GrantThisOLord-B.ly}
\begin{deacon}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Kievan/ToTheeOLord.ly}
...
\lilypondfile[max-protrusion=-0.4in]{./Liturgy/R-Anaphora/AMercyOfPeace-Traditional.ly}

\priestline{The grace of our Lord Jesus Christ and the love of God the Father
  and the communion of the Holy Spirit, be with you all.}
\lilypondfile[max-protrusion=-0.4in]{./Liturgy/R-Anaphora/AndWithThySpirit-Traditional.ly}

\priestline{Let us lift up our hearts.}
\lilypondfile[max-protrusion=-0.4in]{./Liturgy/R-Anaphora/WeLiftThemUp-Traditional.ly}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Obikhod/Amen2.ly}
\end{maybetwocolumns}
...
\needspace{10\baselineskip}
\begin{maybetwocolumns}
\centeredsection{Prayer for the Clergy}
...
\lilypondfile[max-protrusion=-0.4in]{./Liturgy/T-AndAllMankind/AndAllMankind-Plain-Music.ly}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Obikhod/AndWithThySpirit.ly}

\centeredsection{The Litany Before the Lord's Prayer}

\deaconline{Having commemorated all the saints, again and again,
  in peace let us pray to the Lord.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Bachmetev/LordHaveMercy-A.ly}

\deaconline{For the precious gifts which have been spread forth and sanctified,
  let us pray to the Lord.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Bachmetev/LordHaveMercy-B.ly}
...
\deaconline{That our God, who loveth mankind, receiving them upon His holy,
  ...
  let us pray to the Lord.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Bachmetev/LordHaveMercy-C.ly}
...
\deaconline{Asking for the unity of the faith and the communion of the Holy Spirit,
  ...
  \lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Bachmetev/ToTheeOLord.ly}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Obikhod/ToTheeOLord.ly}
...
\priestline{Through the grace and compassions and love toward mankind
  ...
  together with Thine all-holy and good and life-giving Spirit,
  now and ever, and unto ages of ages.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Obikhod/Amen3.ly}
...
\deaconline{Help us; save us; have mercy on us; and keep us, O God, by Thy grace.}
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Obikhod/LordHaveMercy-B.ly}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Obikhod/InTheNameOfTheLord.ly}
...
\lilypondfile[max-protrusion=-0.4in]{./Z-Responses/Obikhod/GNE-Amen.ly}
