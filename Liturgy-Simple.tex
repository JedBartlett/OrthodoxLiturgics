...
\centeredsection{Koinonikon}
\instruction{Hymns are sung while the lamb is prepared.}
\centeredsubsection{For Usual Sundays}
\lilypondfile{./Liturgy/X-Koinonikon/Koinonikon-PraiseTheLord-Music.ly}
\centeredsubsection{Partial Polyeleos (Psalm 135) from Festal Orthros}
\lilypondfile{./Liturgy/X-Koinonikon/OGiveThanksToTheLord-Music.ly}
\centeredsection{The Lord is My Shepherd (Psalm 33)}
\lilypondfile{./Liturgy/X-Koinonikon/TheLordIsMyShepherd-RusT8-Music.ly}
\cleardoublepage
...
% This leaves the above hymn kind of orphaned,
% but adding a clearpage here places the next 3 songs on opposing sheets.
\clearpage
