...
\input{./Horologian/NinthHourText} % Get all of the content
...
\begin{variables}{timberwolf}
    ...
    \vspace{-12pt} %Tone 1 needs to be crammed in a bit to fit on 1 8.5 x 11
    \lilypondfile{./Octoechos/ResurrectionalApolytikion-Tone1-Kazan-Music.ly}
    \subsubsection{Tone 1 - Theotokion}
    \vspace{-16pt} %Tone 1 needs to be crammed in a bit
