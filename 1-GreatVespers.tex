...
\lilypondfile{./Z-Responses/HannonMinor/Amen.ly}
...
\end{deacon}
\lilypondfile{./Z-Responses/HannonMinor/LordHaveMercy-A.ly}

\begin{deacon}
\item For the peace from above, and for the salvation of our souls,
    let us pray to the Lord.
\end{deacon}
\lilypondfile{./Z-Responses/HannonMinor/LordHaveMercy-B.ly}
...
\item Calling to remembrance our all-holy, immaculate, most blessed and glorious Lady Theotokos
    ...
    \lilypondfile[staffsize=10]{./Z-Responses/HannonMinor/MostHolyTheotokosSaveUs.ly}\\
    and ever-virgin Mary, with all the Saints: let us commend ourselves and
    each other, and all our life unto Christ our God.
\end{deacon}

\lilypondfile{./Z-Responses/HannonMinor/ToTheeOLord.ly}
...
\lilypondfile{./Z-Responses/HannonMinor/GrantThisOLord-A.ly}

\begin{deacon}
\item An angel of peace, a faithful guide, a guardian of our souls and bodies,
    let us ask of the Lord.
\end{deacon}
\lilypondfile{./Z-Responses/HannonMinor/GrantThisOLord-B.ly}
...
\end{priest}
\lilypondfile{./Z-Responses/HannonMinor/AndToThySpirit.ly}
...
\item Wisdom!
\end{deacon}
\lilypondfile{./Z-Responses/HannonMinor/FatherBless.ly}
