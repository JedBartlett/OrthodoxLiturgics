...
\priestline{Glory to Thee, O God \instruction{(x3)}}
...
\item O heavenly King, Comforter, the Spirit of truth,
  who art everywhere present and fill all things,
...
\emph{``Holy God, Holy Mighty, Holy Immortal: have mercy on us. (x3)''}}
...
\begin{reader}
\item Amen.
\item Lord, have mercy. \instruction{(x12)}
...
\begin{reader}
  ...
  \item Alleluia. Alleluia. Alleluia. Glory to Thee, O God. \instruction{(x3)}
  \item Lord have mercy. \instruction{(x3)}
  \item Glory to the Father and to the Son and to the Holy Spirit.
\end{reader}
...
\readerline{Both now and ever and unto ages of ages. Amen.}
...
\readerline{Lord have mercy. \instruction{(40x)}}
...
\centeredsection{(Lent) -- The Prayer of Sain Ephriam the Syrian}
\instruction{During Lent}
\input{./Common/PrayerOfStEphriam.tex}

\instruction{Then, twelve metanias are made saying each time:}
\priestline{O God, be gracious unto me the sinner.}

\instruction{The prayer of Sait Ephriam is said again with only one prostration
